...
// DONE You need to replace all instances of "action-handler-donder-footer" with "action-handler-<your card name>"
customElements.define('action-handler-donder-footer', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-donder-footer')) {
    return body.querySelector('action-handler-donder-footer') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-donder-footer');
